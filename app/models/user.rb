class User < ApplicationRecord
  ...
  validates :first_name_kana, presence: true, format: { with: /\A[ァ-ヶ]+\z/, message: 'must be full-width katakana characters'}
  validates :last_name_kana, presence: true, format: { with: /\A[ァ-ヶ]+\z/, message: 'must be full-width katakana characters'}
